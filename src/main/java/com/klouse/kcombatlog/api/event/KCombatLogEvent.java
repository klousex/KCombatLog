package com.klouse.kcombatlog.api.event;
...
public final class KCombatLogEvent extends Event {
    ...
    public KCombatLogEvent(Player player, String attackerName, String reason, CombatManager.CombatLogPunishmentMode punishmentMode) {
        this.player = player;
