package com.klouse.kcombatlog.listener;

import com.klouse.kcombatlog.KCombatLogPlugin;
import com.klouse.kcombatlog.api.event.KCombatLogEvent;
...
public final class ConnectionListener implements Listener {
    ...
    public ConnectionListener(KCombatLogPlugin plugin, CombatManager combatManager, AuraCombatBridgeManager auraCombatBridgeManager) {
        this.plugin = plugin;
    ...
    private void handleLeave(Player player, boolean punish, String reason) {
        ...
        Bukkit.getPluginManager().callEvent(new KCombatLogEvent(
                player,
