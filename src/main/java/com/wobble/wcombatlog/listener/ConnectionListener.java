...
import com.wobble.wcombatlog.api.event.WCombatLogEvent;
...
public final class ConnectionListener implements Listener {
    ...
    public ConnectionListener(WCombatLogPlugin plugin, CombatManager combatManager, AuraCombatBridgeManager auraCombatBridgeManager) {
        this.plugin = plugin;
    ...
    private void handleLeave(Player player, boolean punish, String reason) {
        ...
        Bukkit.getPluginManager().callEvent(new WCombatLogEvent(
                player,
